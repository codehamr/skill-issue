...
CAPTURES = (
    ...
    Capture(
        "body",
        "stand_fp_body.png",
        "First-person view down the standing body",
        PLAYER_BASE + ("weapon ar", "wait 60", "look 0 3500"),
    ),
    Capture(
        "body",
        "crouch_fp_body.png",
        "First-person view down the crouched body",
        PLAYER_BASE
        + ("weapon ar", "+crouch", "wait 60", "look 0 3500"),
    ),
    Capture(
        "ads",
        "ads_fp_ar.png",
