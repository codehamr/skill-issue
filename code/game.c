...
//   harness   --do / --script. EGL surfaceless rendering into an FBO, driven
//             by the script language usage() documents. Linux only; report
//             the actual GL renderer rather than assuming hardware or software.
...
#include <math.h>
#include <stdarg.h>
#include <stdatomic.h>   // audio command lanes and cross-thread lifecycle state
#include <stdio.h>
#include <stdint.h>
#include <stdlib.h>
#include <string.h>
...
// inclusion, in definition order — C requires helpers before their use,
...
// list below is the subsystem index.
// ---------------------------------------------------------------------------
