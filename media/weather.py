...
SHOTS = (
    dict(key="01-clear-forest", title="Licht zwischen den Bäumen", seed=7, weather=0,
         ...
         caption="Ein überwachsener Steinbruch mit massiven Felskanten, offenen Wegen und warmem Tageslicht."),
    ...
    dict(key="03-mist-forest", title="Nebel über dem Wald", seed=4, weather=1,
         ...
         caption="Wurzeln hängen über den Abbaukanten. Hinter den freien Außenwegen verblassen Bäume und Berge im Nebel."),
