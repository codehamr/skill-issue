...
SHOTS = (
    dict(key="01-clear-forest", title="Licht zwischen den Bäumen", seed=7, weather=0,
         ...
         caption="Eine natürliche Waldarena mit offenen Wegen, festem Stammholz und warmem Tageslicht."),
    ...
    dict(key="03-mist-forest", title="Nebel über dem Wald", seed=4, weather=1,
         ...
         caption="Die nahe Deckung bleibt sichtbar, während Bäume und Berge in der Entfernung verblassen."),
