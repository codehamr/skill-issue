...
SHOTS = (
    dict(key="aurora", title="Nordlicht am Außenposten", seed=28,
         ...
         biome="aurora", sun=None, camera="16 2.8 -18 -2.55 0.10"),
    ...
    dict(key="red-post", title="Rotes Wachlicht", seed=19,
         ...
         biome="night", sun=None, camera="7 2.1 16 -0.95 0.05"),
    dict(key="winter", title="Stiller Winter", seed=22,
         ...
         biome="frost", sun=None, camera="17 3.0 19 -0.73 0.04"),
    dict(key="forest", title="Wege in der Waldmulde", seed=4,
         ...
         biome="forest", sun=None, camera="17 2 19 -0.73 0.07"),
    ...
    dict(key="dunes", title="Dünen im Morgenlicht", seed=59,
         ...
         biome="dunes", sun=None, camera="17 5 19 -0.73 -0.13"),
    dict(key="sand-detail", title="Sand im Gegenlicht", seed=59,
         ...
         biome="dunes", sun=None, camera="-8 0.65 18 0.515 -0.16"),
